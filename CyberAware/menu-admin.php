...
<div class="w3-top" style="z-index=0">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    ...
    <div class="w3-right w3-hide-small">
	  ...
	  <a href="a-assessment.php" class="w3-bar-item1 w3-button"> ASSESSMENT</a>  
	  <a href="a-question.php" class="w3-bar-item1 w3-button"> QUESTION</a>  
	  <a href="a-tutorial.php" class="w3-bar-item1 w3-button"> TUTORIAL</a>
...
<nav class="w3-sidebar w3-bar-block w3-indigo w3-card w3-animate-left w3-hide-medium w3-hide-large" style="display:none" id="mySidebar">
  ...
  <a href="a-assessment.php" onclick="w3_close()" class="w3-bar-item w3-button">ASSESSMENT</a>
  <a href="a-question.php" onclick="w3_close()" class="w3-bar-item w3-button">QUESTION</a>
  <a href="a-tutorial.php" onclick="w3_close()" class="w3-bar-item w3-button">TUTORIAL</a>
